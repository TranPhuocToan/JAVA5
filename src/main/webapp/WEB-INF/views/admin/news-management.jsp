				...
				<div class="tile">
					<div class="tile-body">
						...
						<div class="col-sm-2">
								...
								<a class="btn btn-add btn-sm" href="/news/form-news"
									title="Thêm"><i class="fas fa-plus"></i> Tạo bản tin mới</a>
							</div>
							<div class="col-sm-2">
	...
	<script>
		...
		function confirmDelete(article_id) {
			...
			if (result) {
				...
				xhr.open("GET", "/news/delete/" + article_id, true);
