							...
							<div class="row">
								<div class="col-md-12">
									<div class="tile">
										...
										<form class="row" action="" modelAttribute="" enctype="multipart/form-data">
											<div class="form-group col-md-4">
												<label class="control-label">Mã sản phẩm</label>
												<input path="" class="form-control" readonly="" />
											...
											<div class="form-group  col-md-4">
												...
												<input path="" class="form-control" type="number" />
												<!-- <input class="form-control"
												type="number" /> -->
											</div>
											<div class="form-group col-md-4">
											...
											<div class="form-group col-md-4">
												...
												<input path="product_price" class="form-control" type="number" />
												<!-- <input class="form-control"
												type="number" /> -->
											</div>
											<div class="form-group col-md-4">
												<label class="control-label">Giá vốn</label>
												<input path="capital_price" class="form-control" type="number" />
												<!-- <input class="form-control"
												type="number" /> -->
											</div>
											<div class="form-group col-md-4">
											...
											<div class="form-group col-md-12">
												...
												<textarea class="form-control" path="description" rows="5"></textarea>
