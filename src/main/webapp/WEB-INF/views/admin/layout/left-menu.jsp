		...
		<body>
			...
			<aside class="app-sidebar">
				<div class="app-sidebar__user">
					<img class="app-sidebar__user-avatar" src="/images/products/Admin.png'/>" width="50px">
					<div>
				...
				<ul class="app-menu">
					<li><a class="app-menu__item" href="/admin/orderreport"><i
								class='app-menu__icon bx bx-tachometer'></i><span class="app-menu__label">Bảng đơn
								hàng chờ</span></a></li>
					...
					<li><a class="app-menu__item" href="/order/orderreport"><i
								class='app-menu__icon bx bx-task'></i><span class="app-menu__label">Chi tiết 
								đơn hàng</span></a></li>
