...
<body onload="time()" class="app sidebar-mini rtl">
	...
	<main class="app-content">
		<div class="app-title">
			<ul class="app-breadcrumb breadcrumb side">
				<li class="breadcrumb-item active"><a href="#"><b>Sản
							phẩm giảm giá</b></a></li>
			</ul>
			<div id="clock"></div>
		</div>
		<div class="row">
					...
					<div class="tile-body">
						<div class="row element-button">
							<div class="col-sm-2">
								...
								<a class="btn btn-add btn-sm" href="/discount/form-discount"
									title="Thêm"><i class="fas fa-plus"></i> Thêm sản phẩm giảm
									giá</a>
							</div>
							<div class="col-sm-2">
						...
						<table class="table table-hover table-bordered" id="sampleTable">
							...
							<tbody>
								<tr>
									<c:forEach var="discount" items="1">
										<td>1</td>
										<td>1</td>
										<td><img src="/img/1"
											class="img-card-person"></td>
										<td>1</td>
										<td>1</td>
										<td>1</td>
	...
	/* function confirmDelete(discountId) {
	    ...
	    if (result) {
	        ...
	        xhr.open("GET", "/discount/delete/" + discountId, true);
