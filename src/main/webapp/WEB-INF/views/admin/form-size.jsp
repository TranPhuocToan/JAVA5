                    ...
                    <%@include file="/WEB-INF/views/admin/layout/left-menu.jsp" %>
                        ...
                        <main class="app-content">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="tile">
                                        <h3 class="tile-title">Tạo kích cỡ</h3>
                                        <div class="tile-body">
                                            <form:form action="/size/create" modelAttribute="size"
                                                enctype="multipart/form-data">
                                                <div class="row">
                                                    <div class="form-group  col-md-4">
                                                        <label class="control-label">ID Kích cỡ</label>
                                                        <form:input path="sizeId" class="form-control"
                                                            readonly="True" />
                                                    </div>
                                                    <div class="form-group  col-md-4">
                                                        <label class="control-label">Tên kích cỡ</label>
                                                        <form:input path="sizeName" class="form-control" />
                                                    </div>
                                                </div>
                                                <button class="btn btn-save">Lưu lại</button>
                                                <a class="btn btn-cancel" href="/size">Hủy bỏ</a>
                                            </form:form>
                                        </div>
