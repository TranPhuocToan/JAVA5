                ...
                <main class="app-content">
                    <div class="app-title">
                        <ul class="app-breadcrumb breadcrumb">
                            <li class="breadcrumb-item">Danh sách Brand</li>
                            <li class="breadcrumb-item"><a href="#">Thêm Brand</a></li>
                        </ul>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="tile">
                                <h3 class="tile-title">Tạo Brand</h3>
                                <div class="tile-body">
                                    <form class="row">
                                        <div class="form-group  col-md-4">
                                            <label class="control-label">ID Brand</label>
                                            <input class="form-control" type="text">
                                        </div>
                                        <div class="form-group  col-md-4">
                                            <label class="control-label">Tên Brand</label>
                                            <input class="form-control" type="text">
                                        </div>
                                </div>
