                            ...
                            <div class="d-inline-flex align-items-center">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <c:choose>
                                            <c:when test="${userSession==null}">
                                                <a href="/account/login" class="dropdown-item" type="button">Sign in</a>
                                                <a href="/account/register" class="dropdown-item" type="button">Sign
                                                    up</a>
                                            </c:when>
                                            <c:otherwise>
                                                <a href="/account/logout" class="dropdown-item" type="button">Sign
                                                    out</a>
                                            </c:otherwise>
                                        </c:choose>
                                ...
                                <div class="btn-group">
                                    <button id="languageDropdown" type="button"
                                        class="btn btn-sm btn-light dropdown-toggle" data-toggle="dropdown">
                                        <s:message code="tb.NN" />
                                    </button>
                                    <div class="dropdown-menu dropdown-menu-right">
