<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <body>
        <div class="form-container" style="margin:100px auto;">
            ...
            <form class="form" action="/account/forgotPass" method="post">
                <input type="email" name="email" class="input" placeholder="Email" required>
                <p class="page-link">
                    <span class="page-link-label"><a class="sign-up-link" href="/account/login">Sign In</a></span>
                </p>
                <button type="submit" class="form-btn">Send</button>
            </form>
            <p class="sign-up-label">
                Don't have an account?<a href="/account/register"><span class="sign-up-link">Sign up</span></a>
            </p>
