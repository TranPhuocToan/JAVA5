                    ...
                    <%@include file="../../views/user/common/_topbar.jsp" %>
                        ...
                        <%@include file="../../views/user/common/_navbar.jsp" %>
                                            ...
                                            <div class="carousel-inner">
                                                <div class="carousel-item position-relative active"
                                                    ...
                                                    <img class="position-absolute w-100 h-100"
                                                        src="../assets/user/img/carousel-1.jpg"
                                                ...
                                                <div class="carousel-item position-relative" style="height: 430px;">
                                                    <img class="position-absolute w-100 h-100"
                                                        src="../assets/user/img/carousel-2.jpg"
                                                        style="object-fit: cover;">
                                                    <div
                                                        class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                                        <div class="p-3" style="max-width: 700px;">
                                                ...
                                                <div class="carousel-item position-relative" style="height: 430px;">
                                                    <img class="position-absolute w-100 h-100"
                                                        src="../assets/user/img/carousel-3.jpg"
                                                        style="object-fit: cover;">
                                                    <div
                                                        class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                                        <div class="p-3" style="max-width: 700px;">
                            ...
                            <div class="container-fluid pt-5">
                                ...
                                <div class="row px-xl-5 pb-3">
                                    <c:forEach items="${categorySl}" var="category">
                                        <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                                            <a class="text-decoration-none" href="">
                                                <div class="cat-item img-zoom d-flex align-items-center mb-4">
                                                    <div class="overflow-hidden" style="width: 100px; height: 100px;">
                                                        <img class="img-fluid" src="../assets/user/img/cat-3.jpg"
                                                            alt="">
                                                    </div>
                                                    <div class="flex-fill pl-3">
                                                        <h6>${category.key}</h6>
                                                        <small class="text-body">${category.value} Product</small>
                                                    </div>
                                                </div>
                                            </a>
                                        </div>
